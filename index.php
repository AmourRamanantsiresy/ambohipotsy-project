    ...
    <body id="body">
        ...
        <div class="container1" id="doc">
            <div class="w-50 mt-5 p-5">
                ...
                <div class="form-group">
                    <p class="m-1">
                        Tsindrio ny efa-joro eo ambany ary safidio ilay rakitra tiana alefa.
                    </p>
                    <form name="form" action="server.php" enctype="multipart/form-data" method="post">
                        <div id="champ1">
                            <label for="file" class="label-file lf1">Safidio ny rakitra</label>
        ...
        <div class="card w-25" id="bienvenue">
            ...
            <div class="container h0" id="bieContainer">
                <p>Togasoa eto amin'ny tranokala fanangonana tahiri-kevitra</p>
                <p>Ahoana ny fampiasa azy ?</p>
                <p>
                    Ireo bokitra roa ery ambony avanana no ampiasaina rehefa andefa rakitra.
